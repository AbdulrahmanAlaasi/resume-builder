...
export default function ExperienceForm() {
  ...
  return (
    <div className="fade-in-up">
      <p className="form-caption">Work, internships, co-op positions, and projects. Use the same format for every experience entry.</p>
      ...
      {data.experiences.map((exp, i) => (
        <div key={exp.id} className="section-card">
          ...
          <div className="form-grid">
            <div className="full">
              <label className="form-label">Institution / Company / Project</label>
