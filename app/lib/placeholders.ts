...
export const FORM_PLACEHOLDERS = {
  // Contact
  contactFullName: 'Ahmed Al-Rashidi',
  contactPhone:    '+966 55 123 4567',
  contactEmail:    'ahmed@university.edu.sa',
  contactCity:     'Riyadh',
  ...
  projTitle:       'Senior Capstone — Smart Traffic System',
  projStartDate:   'September 2024',
  projEndDate:     'May 2025',
  projBullet:      'Describe the project scope, technologies used, and outcomes.',

  // Volunteer
  volunteerText: 'Student Council Vice-President — organised campus-wide career fair (300+ attendees).',
